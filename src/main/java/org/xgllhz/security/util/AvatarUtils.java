...
public class AvatarUtils {
     ...
     * @throws IOException
     */
    public static String generateAvatar(String name) throws IOException {
        int width = 100;
        int height = 100;
        ...
        String filePath = YmlConfig.getFileAvatarDir() + File.separator + fileName;
    ...
    public static void main(String[] args) {
        try {
            System.out.println(AvatarUtils.generateAvatar("香格里拉皇子"));
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
